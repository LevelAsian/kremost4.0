 ...
 *
 *      var www = connect();
 *      www.use(connect.favicon());
 *      www.use(connect.logger());
 *      www.use(connect.static(__dirname + '/public'));
 *
 * If we wanted to prefix static files with _/public_, we could
 * "mount" the `static()` middleware:
 *
 *      www.use('/public', connect.static(__dirname + '/public'));
 *
 ...
 *      https.createServer(options, www).listen(443);
 *
 * @return {http.Server}
 * @api public
 */
